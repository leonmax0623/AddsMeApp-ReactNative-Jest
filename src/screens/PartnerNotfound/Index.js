...
// start
export default class PartnerNotfoundScreen extends Component {
	constructor(props) {
		super(props)
		this.state = {
			user:null
	...
	render() {
		...
		return <View style={styles.wrapper}>
				<View style={s.warning}>
					...
					<Text style={[styles.text,styles.bold,styles.center]}>Продавец не найден!</Text>
					<Text style={[styles.text,styles.mt20,styles.center]}>Продавец приостановил свою деятельность или вы перешли по недействительной ссылке.</Text>
				</View>
				<View style={s.back}>
